...
const Search = () => {
    ...
    return (
        ...
        <form action="#" >
            <div className="flex items-end space-x-2 py-2 px-3 group focus-within:bg-black/30 transition-all border-b border-white/50 focus-within:border-b-0 focus-within:rounded-md">
                {showInput ? (
